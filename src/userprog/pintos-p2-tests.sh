...
test-bogus()
{
    ...
    pintos -v -k -T 60 --qemu --filesys-size=2 -p tests/userprog/bogus -a bogus -- -q  -f run bogus < /dev/null 2> tests/userprog/bogus.errors |tee tests/userprog/bogus.output
    echo -e "Result:"
